...
data class ChecksumLong(
    val ll: LongArray,
    val hash: Int = ll.contentHashCode()
    ...
    override fun equals(other: Any?) = this === other || other is ChecksumLong && ll.contentEquals(other.ll)
    ...
    val bloomFilterHash1: Long
        get() = TODO("enable if bloom filters are really used")
