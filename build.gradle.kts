...
tasks {
    create<JavaExec>("generateDatabase") {
        ...
        val usage = "\n\n" + """
                ...
                Options can be also specified in webdetect.properties and local.properties. 
                
                Options:
                  -Pinput=<input path>    path to CSV generated by scanner from webdetect_py (required)
